...
export const AIAssistant: React.FC<AIAssistantProps> = ({ subjects, currentSubjectId }) => {
  ...
  const loadData = async () => {
    ...
    const examsArray = Array.isArray(loadedExams) ? loadedExams : [];
    setExams(examsArray.sort((a, b) => new Date(a.date + 'T00:00:00').getTime() - new Date(b.date + 'T00:00:00').getTime()));
  };
