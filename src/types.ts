...
export const WALLPAPERS = [
    { id: 'none', label: 'Minimal Dark', url: '' },
    { id: 'lofi', label: 'Lofi Study', url: 'https://images.unsplash.com/photo-1516339901600-2e1a62986307?auto=format&fit=crop&q=80&w=1920' },
    { id: 'forest', label: 'Deep Forest', url: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&q=80&w=1920' },
    { id: 'space', label: 'Nebula', url: 'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?auto=format&fit=crop&q=80&w=1920' },
    { id: 'rain', label: 'Rainy Window', url: 'https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&q=80&w=1920' },
];
